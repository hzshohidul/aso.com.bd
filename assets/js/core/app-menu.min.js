! function(n, e, d) {
    ...
    d.app.menu = {
                ...
                if (this.obj) {
                    ...
                    if (!0 === d(".main-menu").data("scroll-to-active")) e = 0 < d(".main-menu-content").find("li.active").parents("li").length ? d(".main-menu-content").find("li.active").parents("li").last().position() : d(".main-menu-content").find("li.active").position(), setTimeout(function() {
                        void 0 !== e && d.app.menu.container.stop().animate({
                            scrollTop: e.top
                        }, 300), d(".main-menu").data("scroll-to-active", "false")
                    }, 300);
                    this.obj.update()
                }
            },
        ...
        change: function(e) {
            ...
            "vertical-menu" !== s && "vertical-menu-modern" !== s || this.toOverlayMenu(n.name), l.is(".horizontal-layout") && !l.hasClass(".horizontal-menu-demo") && (this.changeMenu(n.name), d(".menu-toggle").removeClass("is-active")), "horizontal-menu" != s && this.drillDownMenu(n.name), "xl" == n.name && (d('body[data-open="hover"] .dropdown').on("mouseenter", function() {
            ...
            })), d(".header-navbar").hasClass("navbar-brand-center") && d(".header-navbar").attr("data-nav", "brand-center"), "sm" == n.name || "xs" == n.name ? d(".header-navbar[data-nav=brand-center]").removeClass("navbar-brand-center") : d(".header-navbar[data-nav=brand-center]").addClass("navbar-brand-center"), d("ul.dropdown-menu [data-toggle=dropdown]").on("click", function(e) {
            ...
            }), "horizontal-menu" == s && ("sm" == n.name || "xs" == n.name ? d(".menu-fixed").length && d(".menu-fixed").unstick() : d(".navbar-fixed").length && d(".navbar-fixed").sticky()), "vertical-menu" !== s && "vertical-overlay-menu" !== s || (jQuery.expr[":"].Contains = function(e, n, a) {
        ...
        collapse: function(e) {
            !1 === this.collapsed && ("vertical-menu-modern" == l.data("menu") && (d(".modern-nav-toggle").find(".toggle-icon").removeClass("ft-disc").addClass("ft-circle"), "undefined" != typeof Storage && localStorage.setItem("menuLocked", "false")), this.transit(function() {
                ...
                "horizontal-menu" == l.data("menu") && l.hasClass("vertical-overlay-menu") && d(".main-menu").hasClass("menu-fixed") && this.manualScroller.enable(), "vertical-menu" != l.data("menu") && "vertical-menu-modern" != l.data("menu") || !d(".main-menu").hasClass("menu-fixed") || (d(".main-menu-content").css("height", d(n).height() - d(".header-navbar").height()), d(".main-menu-content").hasClass("ps") || this.manualScroller.enable())
            }))
        },
        ...
        adjustSubmenu: function(e) {
            var n, a, i, s, t, o, l = e.children("ul:first"),
                r = l.clone(!0);
